...
{
       0,   108,   108,   115,   123,   127,   128,   129,   135,   145,
     151,   155,   162,   166,   177,   183,   192,   197,   203,   214,
     221,   231,   235,   236,   240,   241,   245,   254,   262,   266,
     276,   278,   282,   286,   295,   297,   301,   302,   306,   307,
     312,   318,   319,   326,   332,   337,   342,   347,   355,   362,
     369,   378,   380,   386,   390,   395,   399,   401,   405,   407,
     411,   412,   413,   414,   415,   416,   417,   418,   424,   439,
     443,   444,   448,   450,   458,   470,   482,   483,   487,   499,
     510,   518,   522,   523,   527,   537,   543,   547,   548,   552,
     562,   563,   564,   568,   569,   573,   578,   579,   580,   581,
     582,   583,   587,   588,   589,   593,   594,   595
};
#endif
...
#line 109 "parser.y"
      { 
        rootNode = (yyvsp[0].node); // Capture the head of the list as the global root
      }
...
#line 136 "parser.y"
      {
        ...
        (yyval.node)->name = (yyvsp[-5].sval);         // Class Name
        (yyval.node)->left = (yyvsp[-4].node);         // Inheritance List
        (yyval.node)->right = (yyvsp[-2].node);        // Member List (attributes/methods)
      }
...
#line 146 "parser.y"
      {
         ...
         (yyval.node)->name = (yyvsp[-1].sval);        // The first parent class
         (yyval.node)->next = (yyvsp[0].node);        // Subsequent parent classes
      }
...
#line 167 "parser.y"
      {
        ...
        */
        (yyval.node) = (yyvsp[-1].node);
        if ((yyval.node)) {
             (yyval.node)->visibility = (yyvsp[-2].node)->name; // e.g., "public"
             (yyval.node)->next = (yyvsp[0].node);             // Link to next member
        }
      }
...
#line 184 "parser.y"
      {
        ...
        (yyval.node)->right = (yyvsp[-1].node); // List of function definitions
      }
...
#line 204 "parser.y"
      {
        ...
        (yyval.node)->name = (yyvsp[-1].node)->name;       // Hoist name for easier access
        (yyval.node)->left = (yyvsp[-1].node);             // Signature (params, return type)
        (yyval.node)->right = (yyvsp[0].node);            // Body (statement list)
      }
...
#line 215 "parser.y"
      {
        ...
        (yyval.node)->left = (yyvsp[-3].node);  // Parameters
        (yyval.node)->right = (yyvsp[0].node); // Return Type
      }
...
#line 222 "parser.y"
      {
        (yyval.node) = createNode(NODE_FUNC_HEAD);
        (yyval.node)->name = strdup("construct"); // Special reserved name
        (yyval.node)->left = (yyvsp[-1].node);
        (yyval.node)->right = NULL; // Constructors have no return type
      }
...
#line 246 "parser.y"
      {
         (yyval.node) = (yyvsp[-1].node); // Just a prototype, no body
      }
...
#line 267 "parser.y"
      {
        ...
        (yyval.node)->type_name = (yyvsp[-2].node)->name; // Extract "integer"/"float" string
        (yyval.node)->left = (yyvsp[-1].node);            // Array dimensions (if any)
      }
...
#line 283 "parser.y"
      {
        (yyval.node) = createLiteralInt((yyvsp[-1].ival));
      }
...
#line 287 "parser.y"
      { 
        (yyval.node) = createLiteralInt(-1); // -1 signifies dynamic/empty array syntax
      }
...
#line 313 "parser.y"
      {
        ...
        (yyval.node)->left = (yyvsp[-3].node);  // L-Value
        (yyval.node)->right = (yyvsp[-1].node); // R-Value
      }
...
#line 320 "parser.y"
      {
        ...
        (yyval.node)->left = (yyvsp[-6].node);  // Condition
        (yyval.node)->right = (yyvsp[-3].node); // Then Block
        (yyval.node)->extra = (yyvsp[-1].node); // Else Block
      }
...
#line 1782 "parser.tab.c"
  ...
  case 58: /* term: term multOp factor  */
#line 406 "parser.y"
      { (yyval.node) = createBinary((yyvsp[-1].node)->op, (yyvsp[-2].node), (yyvsp[0].node)); }
...
#line 1800 "parser.tab.c"
  ...
  case 61: /* factor: functionCall  */
#line 412 "parser.y"
                   { (yyval.node) = (yyvsp[0].node); }
#line 1806 "parser.tab.c"
    break;

  case 62: /* factor: LITERAL_INTEGER  */
#line 413 "parser.y"
                      { (yyval.node) = createLiteralInt((yyvsp[0].ival)); }
#line 1812 "parser.tab.c"
    break;

  case 63: /* factor: LITERAL_FLOAT  */
#line 414 "parser.y"
                      { (yyval.node) = createLiteralFloat((yyvsp[0].fval)); }
#line 1818 "parser.tab.c"
    break;

  case 64: /* factor: '(' arithExpr ')'  */
#line 415 "parser.y"
                        { (yyval.node) = (yyvsp[-1].node); }
...
#line 417 "parser.y"
                              { (yyval.node) = createUnary("-", (yyvsp[0].node)); }
#line 1836 "parser.tab.c"
    break;

  case 67: /* factor: '+' factor  */
#line 418 "parser.y"
                              { (yyval.node) = createUnary("+", (yyvsp[0].node)); }
#line 1842 "parser.tab.c"
    break;

  case 68: /* variable: primaryVar suffix_ZM  */
#line 425 "parser.y"
      {
        if ((yyvsp[0].node) == NULL) {
            (yyval.node) = (yyvsp[-1].node); // Just the ID
        } else {
...
#line 1870 "parser.tab.c"
  ...
  case 71: /* idOrSelf: SELF  */
#line 444 "parser.y"
           { (yyval.node) = createID("self"); }
#line 1876 "parser.tab.c"
    break;

  case 72: /* suffix_ZM: suffix suffix_ZM  */
#line 449 "parser.y"
      { (yyval.node) = (yyvsp[-1].node); (yyval.node)->next = (yyvsp[0].node); }
#line 1882 "parser.tab.c"
    break;

  case 73: /* suffix_ZM: indice_ZM  */
#line 451 "parser.y"
      { 
...
#line 1891 "parser.tab.c"
  ...
  case 74: /* suffix: indice_ZM '.' idOrSelf  */
#line 459 "parser.y"
      {
...
#line 1920 "parser.tab.c"
  ...
  case 76: /* indice_ZM: indice indice_ZM  */
#line 482 "parser.y"
                       { (yyval.node) = (yyvsp[-1].node); (yyval.node)->next = (yyvsp[0].node); }
#line 1926 "parser.tab.c"
    break;

  case 77: /* indice_ZM: %empty  */
#line 483 "parser.y"
               { (yyval.node) = NULL; }
#line 1932 "parser.tab.c"
    break;

  case 78: /* indice: '[' arithExpr ']'  */
#line 488 "parser.y"
      {
        ASTNode *idx = createNode(NODE_VAR_ACCESS);
        idx->op = strdup("[]");
        idx->left = (yyvsp[-1].node); // The index expression
        (yyval.node) = idx;
      }
#line 1943 "parser.tab.c"
    break;

  case 79: /* functionCall: primaryVar '(' aParams ')'  */
#line 500 "parser.y"
      {
        (yyval.node) = createNode(NODE_FUNC_CALL);
        (yyval.node)->name = (yyvsp[-3].node)->name; // Function name
        (yyval.node)->left = (yyvsp[-1].node);       // Arguments
      }
#line 1953 "parser.tab.c"
    break;

  case 80: /* fParams: ID ':' type arraySize_ZM fParamsTail_ZM  */
#line 511 "parser.y"
      {
         (yyval.node) = createNode(NODE_PARAM);
         (yyval.node)->name = (yyvsp[-4].sval);
         (yyval.node)->type_name = (yyvsp[-2].node)->name;
         (yyval.node)->left = (yyvsp[-1].node); // Array dimension info
         (yyval.node)->next = (yyvsp[0].node); // Next param
      }
#line 1965 "parser.tab.c"
    break;

  case 81: /* fParams: %empty  */
#line 518 "parser.y"
               { (yyval.node) = NULL; }
#line 1971 "parser.tab.c"
    break;

  case 82: /* fParamsTail_ZM: fParamsTail fParamsTail_ZM  */
#line 522 "parser.y"
                                 { (yyval.node) = (yyvsp[-1].node); (yyval.node)->next = (yyvsp[0].node); }
#line 1977 "parser.tab.c"
    break;

  case 83: /* fParamsTail_ZM: %empty  */
#line 523 "parser.y"
               { (yyval.node) = NULL; }
#line 1983 "parser.tab.c"
    break;

  case 84: /* fParamsTail: ',' ID ':' type arraySize_ZM  */
#line 528 "parser.y"
      {
         (yyval.node) = createNode(NODE_PARAM);
         (yyval.node)->name = (yyvsp[-3].sval);
...
#line 1994 "parser.tab.c"
  ...
  case 85: /* aParams: expr aParamsTail_ZM  */
#line 538 "parser.y"
      { 
        (yyval.node) = createNode(NODE_LIST); // Wrapper for argument list
        (yyval.node)->left = (yyvsp[-1].node); // First argument
        (yyval.node)->next = (yyvsp[0].node); // Rest of list
      }
#line 2004 "parser.tab.c"
    break;

  case 86: /* aParams: %empty  */
#line 543 "parser.y"
               { (yyval.node) = NULL; }
#line 2010 "parser.tab.c"
    break;

  case 87: /* aParamsTail_ZM: aParamsTail aParamsTail_ZM  */
#line 547 "parser.y"
                                 { (yyval.node) = (yyvsp[-1].node); (yyval.node)->next = (yyvsp[0].node); }
#line 2016 "parser.tab.c"
    break;

  case 88: /* aParamsTail_ZM: %empty  */
#line 548 "parser.y"
               { (yyval.node) = NULL; }
#line 2022 "parser.tab.c"
    break;

  case 89: /* aParamsTail: ',' expr  */
#line 553 "parser.y"
      {
        (yyval.node) = createNode(NODE_LIST);
        (yyval.node)->left = (yyvsp[0].node);
...
#line 2049 "parser.tab.c"
  ...
  case 93: /* returnType: type  */
#line 568 "parser.y"
           { (yyval.node) = (yyvsp[0].node); }
#line 2055 "parser.tab.c"
    break;

  case 94: /* returnType: VOID  */
#line 569 "parser.y"
           { (yyval.node) = createNode(NODE_TYPE); (yyval.node)->name = strdup("void"); }
#line 2061 "parser.tab.c"
    break;

  case 95: /* assignOp: ASSIGN_OP  */
#line 573 "parser.y"
                { (yyval.node) = NULL; }
...
#line 2091 "parser.tab.c"
  ...
  case 100: /* relOp: LE_OP  */
#line 582 "parser.y"
            { (yyval.node) = createNode(NODE_TYPE); (yyval.node)->op = strdup("<="); }
#line 2097 "parser.tab.c"
    break;

  case 101: /* relOp: GE_OP  */
#line 583 "parser.y"
            { (yyval.node) = createNode(NODE_TYPE); (yyval.node)->op = strdup(">="); }
