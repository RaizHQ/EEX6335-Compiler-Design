...
{
       0,    71,    71,    76,    83,    87,    88,    89,    95,   105,
     111,   115,   122,   126,   136,   142,   151,   156,   162,   174,
     181,   191,   195,   196,   200,   201,   205,   214,   222,   226,
     236,   238,   242,   247,   257,   259,   263,   264,   268,   269,
     273,   279,   280,   287,   293,   298,   303,   308,   316,   323,
     330,   339,   341,   347,   351,   353,   357,   359,   363,   365,
     369,   370,   371,   372,   373,   374,   375,   376,   384,   398,
     402,   403,   407,   409,   413,   426,   438,   439,   443,   456,
     467,   475,   479,   480,   484,   494,   500,   504,   505,   509,
     519,   520,   521,   525,   526,   530,   534,   535,   536,   537,
     538,   539,   543,   544,   545,   549,   550,   551
};
#endif
...
#line 77 "parser.y"
      { 
        ...
        else (yyval.node) = (yyvsp[0].node); // Logic safety
      }
...
#line 96 "parser.y"
      {
        ...
        (yyval.node)->right = (yyvsp[-2].node); // Members list
      }
...
#line 106 "parser.y"
      {
         (yyval.node) = createNode(NODE_LIST); // Placeholder for inheritance list
...
#line 127 "parser.y"
      {
        ...
        (yyval.node) = (yyvsp[-1].node);
        if ((yyval.node)) {
             (yyval.node)->visibility = (yyvsp[-2].node)->name; // Transfer "public"/"private" string
             (yyval.node)->next = (yyvsp[0].node);
        }
      }
...
#line 143 "parser.y"
      {
        ...
        (yyval.node)->right = (yyvsp[-1].node); // Functions
      }
...
#line 163 "parser.y"
      {
        ...
        (yyval.node)->name = (yyvsp[-1].node)->name;       // Extract name from head
        (yyval.node)->left = (yyvsp[-1].node);             // Keep head details (params/type) as left child
        (yyval.node)->right = (yyvsp[0].node);            // Body as right child
      }
...
#line 175 "parser.y"
      {
        ...
        (yyval.node)->name = (yyvsp[-5].sval);
        (yyval.node)->left = (yyvsp[-3].node); // Params
...
#line 182 "parser.y"
      {
        ...
        (yyval.node)->right = NULL; // No return type
      }
...
#line 206 "parser.y"
      {
         (yyval.node) = (yyvsp[-1].node); // Just return the head info
      }
...
#line 227 "parser.y"
      {
        ...
        (yyval.node)->type_name = (yyvsp[-2].node)->name; // Extract type string
        (yyval.node)->left = (yyvsp[-1].node); // Array dimensions
      }
...
#line 248 "parser.y"
      { 
        (yyval.node) = createNode(NODE_LITERAL_INT); 
        (yyval.node)->int_val = -1; // -1 represents empty []
      }
...
#line 385 "parser.y"
      {
        if ((yyvsp[0].node) == NULL) {
            ...
            (yyval.node) = (yyvsp[-1].node);
            (yyval.node)->right = (yyvsp[0].node); // Attach suffixes to right
        }
      }
...
#line 414 "parser.y"
      {
        ...
        if ((yyvsp[-2].node)) {
             ...
             dot->left = (yyvsp[-2].node); // Store indices here
        }
        (yyval.node) = dot;
      }
...
#line 444 "parser.y"
      {
        ...
        idx->op = strdup("[]");
        idx->left = (yyvsp[-1].node); // The expression inside [ ]
        (yyval.node) = idx;
      }
...
#line 457 "parser.y"
      {
        ...
        (yyval.node)->left = (yyvsp[-1].node);       // Params
      }
...
#line 468 "parser.y"
      {
         ...
         (yyval.node)->left = (yyvsp[-1].node); // Array size info
...
#line 495 "parser.y"
      { 
        (yyval.node) = createNode(NODE_LIST); // Wrapper for arg list
        (yyval.node)->left = (yyvsp[-1].node);
        (yyval.node)->next = (yyvsp[0].node); 
      }
...
int main(void) {
    ...
    if (yyparse() == 0) {
        ...
        // 2. Output the AST to file
        ast_print(rootNode, "ast.txt");
        
        // 3. Initialize and Build Symbol Table
        sym_init();                 // Initialize global scope
        build_symbol_table(rootNode); // Walk the AST to populate the table
        
        // 4. Output Symbol Table to file
        sym_print("symbol_table.txt"); 
    } else {
        printf("Parsing Failed. No output files generated.\n");
    }
    return 0;
}
