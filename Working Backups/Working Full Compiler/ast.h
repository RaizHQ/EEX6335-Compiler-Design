...
typedef enum {
    ...
    NODE_EXPR_BINOP, NODE_EXPR_UNOP, NODE_VAR_ACCESS, NODE_LITERAL_INT,
...
typedef struct ASTNode {
    ...
    // --- NEW: LINK TO SYMBOL TABLE SCOPE ---
    // This allows the Code Generator to know stack size immediately
    struct Scope *scope; 
} ASTNode;

// ... (Rest of your constructors remain the same) ...
